import { reactive as I, h, render as E } from "vue";
import { FIGHTING_TYPE as v } from "../../_tokens/attrs/index.js";
import { isNumber as x, isString as T } from "../../_utils/is/index.js";
import { warning as H } from "../../_utils/tips/index.js";
const r = I({}), i = (n) => n.props.placement, p = (n) => {
  const o = i(n);
  return r[o].findIndex(
    (s) => s.uid == n.uid
  );
}, f = (n) => n.vnode.el.offsetHeight + 16, N = (n) => {
  const o = p(n), s = i(n);
  if (!(o < 0))
  ...
  const s = (e) => {
    ...
    const t = h(n, e), a = document.createElement("div");
