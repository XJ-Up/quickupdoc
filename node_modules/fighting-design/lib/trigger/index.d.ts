import type { TriggerTrigger, TriggerChange } from './src/interface';
...
export declare const FTrigger: Install<DefineComponent<{
    readonly spacing: {
    ...
    readonly onClose: TriggerChange;
    readonly width: string | number;
    readonly disabled: boolean;
    readonly onChange: TriggerChange;
    readonly spacing: string | number;
    readonly onOpen: TriggerChange;
