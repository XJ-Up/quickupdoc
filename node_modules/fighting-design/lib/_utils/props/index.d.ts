 ...
 * @returns { Object } 配置对象
 */
export declare const setBooleanProp: (defaultVal?: boolean) => {
 ...
 * @returns { Object } 配置对象
 */
export declare const setNumberProp: (defaultVal?: number) => {
 ...
 * @returns { Object } 配置对象
 */
export declare const setStringProp: <T extends string>(defaultVal?: T | undefined, validator?: ((value: T) => boolean) | undefined) => {
    readonly type: PropType<T>;
    readonly default: T extends string ? T : undefined;
    readonly validator?: ((value: T) => boolean) | undefined;
};
/**
 ...
 * @returns { Object } 配置对象
 */
export declare const setStringNumberProp: <T extends string | number>(defaultVal?: T | undefined) => {
 ...
 * @returns { Object } 配置对象
 */
export declare const setObjectProp: <T extends object>(defaultVal?: null) => {
    readonly type: PropType<T>;
 ...
 * @returns { Object } 配置对象
 */
export declare const setFunctionProp: <T extends Function>(defaultVal?: null) => {
    readonly type: PropType<T>;
    readonly default: T | null;
};
/**
 ...
 * @returns { Object } 配置对象
 */
export declare const setArrayProp: <T>(defaultVal?: never[]) => {
    readonly type: PropType<T>;
    readonly default: () => T | null;
};
